...
class LinkList{
	...
	public void insertFirstLinks(String fruitName){
		
		Link newLink = new Link(fruitName);
	...
	public Link find(String fruitName){
		
		Link theLink = firstLink;
		
		if(!isEmpty()){
		
			while(theLink.fruitName != fruitName){
	...
	public Link removeLink(String fruitName){
		...
		while(currentLink.fruitName != fruitName){
